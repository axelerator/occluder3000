...
class BIH2 : public AccelerationStruct {
  ...
  private:
    ...
    void traverse ( const BihNode& node, RadianceRay& r, fliess tmin, fliess tmax, unsigned int depth);
    void traverseIterative ( const BihNode* node, RadianceRay& r, fliess tmin, fliess tmax);
    #ifdef VISUAL_DEBUGGER
